...
function Dashboard({ onLogout }: { onLogout: () => void }) {
  ...
  return <main className="admin-shell" dir="rtl">
    <header className="admin-header"><div><strong>لوحة تحكم ماركوز هوم</strong><small>إدارة ركن القهوة</small></div><div><a href="/admin/overview">اللوحة الموحدة</a><a href="/" target="_blank">عرض الموقع</a><button onClick={onLogout}>تسجيل الخروج</button></div></header>
