...
function FireDashboard({ onLogout }: { onLogout: () => void }) {
  ...
  return <main className="admin-shell" dir="rtl">
    <header className="admin-header"><div><strong>لوحة تحكم ماركوز هوم</strong><small>إدارة جهاز الفير المعطر</small></div><div><a href="/" target="_blank">عرض التطبيق</a><button onClick={onLogout}>تسجيل الخروج</button></div></header>
