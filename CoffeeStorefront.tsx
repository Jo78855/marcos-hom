...
export default function CoffeeStorefront() {
  ...
  const chooseOption = (next: boolean) => { setWithInstallation(next); setApproved(false); };
  ...
  return <main dir="rtl" className="site-shell coffee-site">
