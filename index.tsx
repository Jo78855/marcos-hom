...
const screen=path.startsWith('/shop')?<CustomerStorefront/>:customer?<PublicOrder role="customer" token={customer[1]}/>:technician?<PublicOrder role="technician" token={technician[1]}/>:<App/>;
